...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\ContraceptiveList>
 */
class ContraceptiveListFactory extends Factory
{
    protected $model = ContraceptiveList::class;
